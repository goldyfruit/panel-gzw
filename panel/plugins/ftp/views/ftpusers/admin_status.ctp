	...
	<div class="main">
		...
		<div class="main_display">
			<div class="admin">
				...
				<tr>
					<th><?php echo $paginator->sort(__d('ftp', 'Name', true), 'name'); ?></th>
					<th><?php echo $paginator->sort(__d('ftp', 'UID', true), 'uid'); ?></th>
					<th><?php echo $paginator->sort(__d('ftp', 'GID', true), 'gid'); ?></th>
					<th><?php echo $paginator->sort(__d('ftp', 'Count', true), 'count'); ?></th>
					<th><?php echo $paginator->sort(__d('ftp', 'Homedir', true), 'homedir'); ?></th>
					<th><?php echo $paginator->sort(__d('ftp', 'Accessed', true), 'accessed'); ?></th>
					<th><?php echo $paginator->sort(__d('ftp', 'Modified', true), 'modified'); ?></th>
				</tr>

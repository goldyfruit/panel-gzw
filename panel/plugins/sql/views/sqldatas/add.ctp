	...
	<div class="main">
		...
		<div class="main_display">
			<?php
				...
				/**
				 * Create a hidden form field, this one contain the database ID.
				 */
				echo $form->hidden('Sqldata.user_id', array('value' => $session->read('Auth.User.id')));
				
				/**
				 * Create a hidden form field, this one contain the name of the database.
				 */
			...
			<table>
				...
				<tr>
					...
					<td class="form_part2"><?php echo $form->input('Sqldata.name', array('label' => false, 'size' => '31', 'after' => '<span class="highlight" style="font-family: monospace;">_' . $session->read('Auth.User.name').'</span>')); ?></td>
				</tr>
				<tr>
			...
			<?php echo $form->end(__d('sql', 'Create the database', true)); ?>

		...
		<div class="main_display">
			...
			<table>
				...
				<tr>
					...
					<td class="form_part2"><?php echo $form->radio('Domain.status', array(__d('domain', 'Yes', true), __d('domain', 'No', true)), array('default' => 'Yes', 'legend' => false, 'separator' => '&nbsp&nbsp')); ?></td>
				</tr>
			</table>

...
<div id="content">
	<div class="main">
		...
		<div class="name"><?php __d('crontab', 'Cron management.'); ?>
			<div class="infos">
				<?php __d('crontab', 'This is a list of all scheduled tasks on these service.<br />
		...
		<div class="main_display">
			...
			<table>
				<tr>
					<td class="form_part1"><?php __d('crontab', 'Users list'); ?></td>
					<td class="form_part2"><?php echo $form->input('Cron.user_id', array('label' => false)); ?></td>
				</tr>
				<tr>

		...
		<div class="main_display">
			...
			<table>
				...
				<tr>
					...
					<td class="form_part2"><?php echo $form->radio('Cron.notify', array(__d('crontab', 'Yes', true), __d('crontab', 'No', true)), array('default' => 'No', 'legend' => false, 'separator' => '&nbsp&nbsp')); ?></td>
				</tr>
				<tr>
					<td class="form_part1"><?php __d('crontab', 'Enable cronjob'); ?></td>
					<td class="form_part2"><?php echo $form->radio('Cron.status', array(__d('crontab', 'Yes', true), __d('crontab', 'No', true)), array('default' => 'No', 'legend' => false, 'separator' => '&nbsp&nbsp')); ?></td>
				</tr>
			</table>

			<?php echo $form->end(__d('crontab', 'Create the cronjob', true)); ?>

			<div class="advice">
				<?php echo $html->image('/img/main/advice.png', array('alt' => 'Advice')); ?>
				<?php __d('ftp', 'The email notification is recommended for tasks that are rarely executed so that you can be notified of the proper execution thereof.'); ?>
			</div>

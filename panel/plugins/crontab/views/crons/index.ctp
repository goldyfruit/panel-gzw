	...
	<div class="main">
		...
		<div class="main_display">
			<div class="admin">
				...
				<span class="quotas">
					<?php __d('crontab', 'Cronjob quotas :'); ?> <span class="highlight"><?php echo $quotas; ?></span>
				</span>
				...
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<th><?php echo $paginator->sort(__d('crontab', 'Script', true)); ?></th>
						...
						<th class="actions"><?php echo __d('crontab', 'Actions', true); ?></th>
					</tr>
					...
					<tr class="<?php echo $status->htmlClass($cron['Cron']['status']); ?>">
						...
						<td class="actions">
							<?php echo $html->image('/img/options/admin/edit.png', array('alt' => __d('crontab', 'Edit', true), 'url' => array('controller' => 'crons', 'action' => 'edit', $cron['Cron']['id']))); ?>
							<?php echo $html->link(
